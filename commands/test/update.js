...
module.exports.run = async (bot, message, args) => {
    ...
    const channel = message.guild.channels.cache.find(c => c.id === '467133077475557376')
    ...
    .setFooter('Essa é a 6ª snapshot da 1.18 e a primeira de 2021!', message.guild.iconURL())
    .setColor(16711680);

    var role = '531267169464483860'

    var ee = `<@&${role}> <@&772968044816498709>`, e1;
