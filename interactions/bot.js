...
import { botColor, supportServer, imgOpts } from '../defaults.js';
import { toUTS, botInvite } from '../utils.js';
      ...
      const emb = embed({ title: st.__('BOT.INFO.TITLE') })
          ...
          .addField(
            ...
            st.__(
              ...
              (await client.shard.broadcastEval(c => c.guilds.cache.reduce((acc, g) => acc + g.memberCount, 0))).reduce(
                (acc, c) => acc + c,
                0,
              ),
            ),
